...
namespace BoxToBox.ApplicationService.JwtFeatures
{
    public class JwtHandler
    {
        ...
        public JwtSecurityToken GenerateTokenOptions(SigningCredentials signingCredentials, List<Claim> claims, bool rememberMe)
        {
            var tokenOptions = new JwtSecurityToken(
                ...
                claims: claims,
                expires: rememberMe ? DateTime.Now.AddDays(30) : DateTime.Now.AddMinutes(Convert.ToDouble(_jwtSettings.GetSection("expiryInMinutes").Value)),
